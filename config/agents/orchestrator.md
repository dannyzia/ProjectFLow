...
- These are the currently available modes/agents:
  ...
  * "Code Reviewer" agent (code-reviewer) - Senior engineer performing thorough code reviews. Focuses on quality, security, performance, and maintainability.
  * "Code Skeptic" agent (code-skeptic) - Skeptical and critical code quality inspector. Never accepts claims without proof. Demands logs and verification.
  * "Frontend Specialist" agent (frontend-specialist) - UI/UX expert specializing in frontend components, styles, accessibility, and performance.
  * "Test Engineer" agent (test-engineer) - QA engineer and testing specialist for unit, integration, and E2E tests.
  * "Docs Specialist" agent (docs-specialist) - Technical writing expert for documentation, READMEs, and inline comments.
  * "Code Simplifier" agent (code-simplifier) - Expert refactoring specialist that improves code clarity without changing behavior.
