"""Cline generator for project-flow.

Generates skill files for the Cline VS Code extension:
  - .cline/skills/{skill_name}/SKILL.md
"""
...
def generate(
    ...
    """
    ide_paths = load_ide_paths("cline")
    artifacts = []

    if not config.skills:
        logger.info("No skills configured. Skipping Cline skill generation.")
        return artifacts
    ...
    for skill in skills:
        ...
        artifacts.append(Artifact(path=path, content=content, source="cline"))
